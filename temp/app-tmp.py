...
def electric_blend():
    ...
    try:
        ...
        fee_ceke = float(target.get("fee_ceke_miaoliang", 0) or 0)
        fee_miaoliang = float(target.get("fee_miaoliang_caofeidian", 0) or 0)
        fee_misc = float(target.get("fee_misc", 0) or 0)
